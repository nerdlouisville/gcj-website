...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/gameconjunction",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/gameconjunction",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <footer className="border-t border-[var(--brand-border)] bg-[var(--brand-surface)] py-10 px-4">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-sm text-[var(--brand-muted)]">
        ...
        <div className="text-center sm:text-left">
          ...
          <p>
            Produced by{" "}
            <a href="https://nerdlouisville.org" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--brand-heading)] transition-colors">
              Nerd Louisville
            </a>
            {" "}+{" "}
            <a href="https://www.dukesofhighland.net" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--brand-heading)] transition-colors">
              Dukes of Highland
            </a>
          </p>
        </div>
